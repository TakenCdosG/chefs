...
class acf_field_autocomplete extends acf_field {
    ...
    function __construct() {
         ...
         *  var message = acf._e('autocomplete', 'error');
         */
    ...
    /*
      ...
      // register & include JS
      wp_register_script( 'acf-input-autocomplete', "{$dir}js/input.js" );
      wp_enqueue_script('acf-input-autocomplete');


      // register & include CSS
      wp_register_style( 'acf-input-autocomplete', "{$dir}css/input.css" );
    ...
    /*
      ...
      if( $value < $field['custom_minimum_setting'] )
      {
      $valid = __('The value is too little!','acf-autocomplete'),
      }
