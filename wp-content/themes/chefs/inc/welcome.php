...
class WPEX_Welcome {
    ...
    public function admin_menus() {
        // About
        add_dashboard_page(
                __('Theme Details', 'wpex'), __('Theme Details', 'wpex'), $this->minimum_capability, 'wpex-about', array($this, 'about_screen')
        );

        // Recommended
        add_dashboard_page(
                __('Recommendations | Elegant Theme', 'wpex'), __('Recommendations', 'wpex'), $this->minimum_capability, 'wpex-recommended', array($this, 'recommended_screen')
        );
    }
            ...
            <div>
                <div class="feature-section">
                    ...
                    <div>
                        ...
                        <p>
                            <?php _e('This theme was created by <a href="http://thinkcreativegroup.com/" target="_blank">Think Creative Group</a>.', 'wpex'); ?>
                            <br />
                    ...
                    <div>
                        ...
                        <p>
                            <?php _e('ThinkCreativeGroup.com shall not be held liable for any damages, including, but not limited to, the loss of data or profit, arising from the use of, or inability to use, this theme.', 'wpex'); ?>
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="http://thinkcreativegroup.com/" target="_blank" class="button button-secodary"><?php _e('Theme Page', 'wpex'); ?></a>
                    </div>
