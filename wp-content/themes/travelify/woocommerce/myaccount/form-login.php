    ...
    <div class="col-1">
        ...
        <form method="post" class="login">
            ...
            <p class="form-row">
                ...
                <input type="submit" class="button submit-red-button" name="login" value="<?php esc_attr_e( 'SIGN IN &gt;', 'woocommerce' ); ?>" />
    ...
    <div class="col-2">
        ...
        <form method="post" class="register">
            ...
            <p class="form-row">
                ...
                <input type="submit" class="button submit-red-button" name="register" value="<?php esc_attr_e( 'CREATE AN ACCOUNT &gt;', 'woocommerce' ); ?>" />
            </p>
