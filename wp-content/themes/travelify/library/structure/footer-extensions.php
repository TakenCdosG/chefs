...
function travelify_footer_info() {
    echo '<div class="copyright">' . __(' &copy;', 'travelify') . ' ' . date('Y') . ' ' . travelify_site_link() . '. | <a href="'.get_permalink(628).'">Terms of Use</a>  | <a href="'.get_permalink(607).'">Privacy Policy</a>  |  <a href="'.get_permalink(579).'">Return Policy</a>  | All rights reserved | ' . __('site by', 'travelify') . ' ' . travelify_thinkcreativegroup_link() . '</div><!-- .copyright -->';
}
